...
<title>E-WASTE BOOKING|CLEANVERSE</title>
...
<link href="https://fonts.googleapis.com/css2?family=Baloo+Da+2&family=Montserrat:wght@100&family=Ubuntu:wght@300&display=swap" rel="stylesheet">
  ...
  <link rel="stylesheet" href="e-waste_styles.css">
  <link rel="stylesheet" href="LOGINstyles.css">
</head>
<body>
<div class="CompanyName"><h1><b><a class="company-name" href="index.html">CLEANVERSE</a></b></h1></div>
    <div class="header-text">
    <h1>E-waste Pickup</h1>
    <p>E-waste is hazardous and requires proper disposal.</p>
    </div>
    <div class="service-description">
        <h1>Service Description</h1>
        <p>Services available twice a month. Earn credits based on the amount of e-waste per kg</p>
        <p>CREDITS: 800/kg</p>
...
<input class="finp" id="name" name="slot" type="date">
